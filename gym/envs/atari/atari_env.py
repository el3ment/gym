...
def to_grayscale(ale, arr):
    ale.getScreenGrayscale(arr) # says rgb but actually bgr
    return arr  #.copy()
...
class AtariEnv(gym.Env, utils.EzPickle):
    ...
    def _get_image(self):
        return to_rgb(self.ale, self._screen)

    def _get_image_grayscale(self):
        return to_grayscale(self.ale, self._screen)
